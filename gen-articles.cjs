// EINMALIGER Generator für die 12 Redaktions-Artikel (v3: mit Illustration,
// Rechenbeispiel-Box und Checkliste). Chrome identisch zu den bestehenden Seiten.
const fs = require("fs");
...
const cat = { performance: "Performance", branding: "Branding", social: "Social", daten: "Daten", web: "Web", meinung: "Meinung" };
...
function page(a) {
  const sources = a.sources.map((s) => `<a href="${s.url}" target="_blank" rel="noopener">${s.label}</a>`).join(" · ");
  return `<!DOCTYPE html>
<html lang="de">
<head>
  <meta charset="UTF-8" />
  <meta name="viewport" content="width=device-width, initial-scale=1.0" />
  <title>${a.title} | Lärm-Journal | GRELLWERK</title>
  <meta name="description" content="${a.desc}" />
  <meta property="og:title" content="${a.title} | GRELLWERK" />
  <meta property="og:description" content="${a.ogd}" />
  <meta property="og:image" content="assets/og-image.svg" />
  <link rel="icon" href="assets/favicon.svg" type="image/svg+xml" />
  <link rel="canonical" href="https://dgruenewald97-arch.github.io/opus-test/${a.slug}.html" />
...
${BRUMMER}
  ...
  <!-- ===== Scripts (ES modules, deferred by default) ===== -->
