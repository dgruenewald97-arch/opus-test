...
let css=['reset','tokens','base','components','sections','motion','art','agency','studio','direction','about','home','editorial','interiors','experience'].map(n=>read('css/'+n+'.css')).join('\n');
...
html=html.replace('<script type="module" src="js/main.js?v=13"></script>','<script type="importmap">'+JSON.stringify({imports})+'</script><script type="module">import {initStudio} from "gw/js/studio.js";initStudio(document.querySelector("main"));</script>');
