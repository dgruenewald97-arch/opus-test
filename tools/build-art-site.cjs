...
const {studioPhoto,renderLab}=require('./content/experience.cjs');
...
page('labor','Spielwiese','Krach-Konfigurator, Slogan-Maschine und die Pakete aus dem GRELLWERK-Konzept.','legacy',renderLab(fs.readFileSync(labPath,'utf8')));
