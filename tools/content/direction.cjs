...
function renderHome(){return `<section class="manifesto" aria-label="GRELLWERK / Lärm, der etwas auslöst">
 ...
 <div class="manifesto-note"><p>Vier freie Markenstudien. Zwölf KI-Rollen. Ein Studio-Konzept, in dem Menschen die Richtung vorgeben.</p><span>Strategie · Kreation · Digital</span></div>
 <nav class="manifesto-ctas" aria-label="Entdecken"><a href="arbeiten.html">PROJEKTE<span class="cta-caption">Ideen &amp; Gestaltung ansehen ↗</span></a><a href="ueber-uns.html">STUDIO<span class="cta-caption">Crew &amp; Arbeitsweise kennenlernen ↗</span></a></nav>
...
function renderCrewFeatures(){return `<section class="crew-features" aria-label="Zwei Köpfe aus der Crew">${[
...
module.exports={renderHome,renderProjects,renderAgencyOpening,renderCrewFeatures};
