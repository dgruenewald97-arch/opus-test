...
${['reset','tokens','base','components','sections','motion','art','agency','studio','direction','about','home','editorial','interiors','experience'].map(n=>`<link rel="stylesheet" href="css/${n}.css?v=13">`).join('\n')}
</head>`;}
const BODY_OPEN='<body><a class="skip-link" href="#main">Zum Inhalt springen</a>';
const SCRIPTS='<script type="module" src="js/main.js?v=13"></script>';
