...
export function initJournal() {
  ...
  function applyFilter(cat) {
    ...
    posts.forEach((post) => {
      ...
      post.hidden = !show;
      // Karten nutzen data-reveal (opacity:0 bis gescrollt). Beim Filtern sofort
      // sichtbar machen, sonst bleiben eingeblendete Karten leer/unsichtbar.
      if (show) { post.classList.add("is-visible"); visible++; }
    });
